...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="modal fade in" id="add_program" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" > -->
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="forms-sample" id="form_add_program" role="form" action="new-program.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="msg" class="form-group"></div>
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="programme" class="form-control text-primary border-info" id="inputname" placeholder="Academic Year name" required>
                        </div>
