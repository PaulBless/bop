...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="modal fade in" id="edit_academic<?php  echo $academic_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" > -->
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                   <h4 class="card-title text-white text-center font-weight-bold" id="title">Edit Academic Year</h4>
                    <button type="button" class="close text-white font-weight-bold" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                    
                <div class="modal-body">
                    <form class="forms-sample" id="form_add_user" role="form" action="edit-academic.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" class="form-control text-primary border-info" name="academic_id" value="<?php echo $records['ayid'] ?>">
                    <div id="msg" class="form-group"></div>

                        <div class="form-group row">
                        <label for="exampleInputFirstname" class="col-sm-3 col-form-label text-dark">Academic Name</label>
                        <div class="col-sm-9">
