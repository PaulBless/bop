...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="modal fade in" id="add_session" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" > -->
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                   <h4 class="card-title text-white text-center font-weight-bold" id="title">Add New Session</h4>
                    <button type="button" class="close text-white font-weight-bold" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                    
                <div class="modal-body">
                    <form class="forms-sample" id="form_add_session" role="form" action="new-session.php" method="POST" enctype="multipart/form-data">
                    
                    <div id="msg" class="form-group"></div>

                        <div class="form-group row">
                        <label for="exampleInputFName" class="col-sm-3 col-form-label text-dark">Session Name</label>
                        <div class="col-sm-9">
                            <input type="text" name="session" class="form-control text-primary border-info" id="inputname" placeholder="Academic Year name" required>
                        </div>
